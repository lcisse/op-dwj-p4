...
try{ 
	if (isset($_GET['action'])) {
	    ...
	    elseif ($_GET['action'] == 'addComment') { //AJOUT COMMENTAIRE
	        if (isset($_GET['id']) && $_GET['id'] > 0) {
	            if (!empty($_POST['auteur']) && !empty($_POST['commentaire'])) {
	                ...
	                addComment($_GET['id'], $auteur, $commentaire);
	            }
	            else {
		...
		elseif ($_GET['action'] == 'connexion') { //CONNEXION
	    ...
	    elseif ($_GET['action'] == 'inscription') { //INSCRIPCTON
