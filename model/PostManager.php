...
{
	public function getBillets() //SELECTION BILLETS
	{ 
	    $bdd = $this->dbConnect();
	...
	public function postBillets($titre, $contenu) //INSERER BILLETS
	{ 
	    $bdd = $this->dbConnect();
	...
	public function modifierTitreArticle($titreModifie, $idArticle)//MODIFIER TITRE
	{
		$bdd = $this->dbConnect();
	...
	public function modifierContenuArticle($contenuModifie, $idArticle)//MODIFIER CON
	{
		$bdd = $this->dbConnect();
	...
	public function deleteArticle($idArticle) //DELETE BILLET
	{
		$bdd = $this->dbConnect();
